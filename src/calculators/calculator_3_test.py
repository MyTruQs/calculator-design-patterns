...
def test_calculate_with_variance_error():
    ...
    assert str(excinfo.value) == "Fallha no processo: Variância menor que a multiplicação dos números."
...
def test_calculate():
    ...
    assert response == {'data': {'Calculator': 3, 'variance': 1000000, 'multiplication': 100, 'Success': True}}
